...
**Context** — My self-hosted infrastructure started as a hobby and has quietly become the thing that runs my businesses, my home, and this site.

**Problem** — I wanted production-grade calendars, CRM, ERP, notes, file sync, finance, and home automation without locking myself into a stack of separate SaaS vendors I couldn't control or glue together while paying astronomical monthly fees.

**My role** — I architect and run the whole stack solo, from VPS provisioning and reverse proxy to service orchestration, backups, monitoring, and day-to-day operations.

**Outcome** — One coherent infrastructure runs Chocolat Infini's ERP, this site's booking calendar, my home and shop automation, and a handful of utilities I use every day.
...
- [Cal.com](https://cal.com/) for appointment scheduling
- [Appflowy](https://appflowy.com/) for notes taking
